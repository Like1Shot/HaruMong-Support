<p align="center">
  <img src="docs/assets/Default_Ivory.png" alt="HaruMong" width="120" height="120" style="border-radius: 24px;">
</p>
...
## 습관을 만들고, 펫을 키우고, 삶을 바꾸세요.

함께 성장하는 새로운 친구를 만나보세요! 하루몽은 습관 관리를 따뜻하고 즐거운 경험으로 바꿔줍니다. 습관을 완료할 때마다 귀여운 펫이 더 행복하고 건강해져요.

**간단하지만 강력한 습관 관리** - 물 마시기, 매일 운동하기, 자기 전 독서 등 어떤 습관이든 하루몽과 함께라면 쉽고 재미있게 관리할 수 있어요. 나만의 습관을 만들거나 템플릿에서 선택하고, 연속 달성 기록을 쌓으며 성장하는 모습을 확인하세요.

**진심으로 교감하는 펫** - 가상 펫 친구가 여러분의 하루에 반응해요. 습관을 완료하면 기뻐하고, 하루를 놓치면 여러분을 그리워해요. 이런 감정적 교감이 지금까지 경험하지 못한 동기부여를 선사합니다.

**마음챙김 하루 기록** - 아침에는 오늘의 다짐으로 하루를 시작하고, 저녁에는 감사함으로 하루를 마무리하세요. 체크인 기능이 목표에 집중하고 마음을 챙기는 데 도움을 드려요.

### 주요 기능

- **스마트 습관 관리** - 간단 체크 또는 수량 기반 목표
- **가상 펫 친구** - 여러분의 노력에 반응하는 귀여운 친구
- **데일리 체크인** - 아침 다짐 & 저녁 회고
- **기분 기록** - 감정을 기록하고 패턴을 발견하세요
- **아름다운 위젯** - 홈 화면에서 바로 습관 확인
- **상세한 통계** - 시간에 따른 성장 확인
- **건강 앱 연동** - Apple 건강 앱과 연결
- **iCloud 백업** - 데이터를 안전하게 보관

### 다운로드

<a href="https://apps.apple.com/app/harumong">
  <img src="https://developer.apple.com/assets/elements/badges/download-on-the-app-store.svg" alt="App Store에서 다운로드" height="60">
</a>

iPhone 및 iPad에서 사용 가능. iOS 17.0 이상 필요.
